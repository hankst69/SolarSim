...
BngGridTile::BngGridTile(double originEastingM, double originNorthingM, double cellSizeM,
...
bool BngGridTile::cellValue(int column, int row, double& value) const
{
...
bool BngGridTile::sampleBng(double eastingM, double northingM, double& heightM) const
{
...
bool BngGridTile::sampleGeodetic(double latitudeDeg, double longitudeDeg, double& heightM) const
{
    double easting = 0.0;
    double northing = 0.0;
    BritishNationalGridProjection::forward(latitudeDeg, longitudeDeg, easting, northing);
    return sampleBng(easting, northing, heightM);
}
