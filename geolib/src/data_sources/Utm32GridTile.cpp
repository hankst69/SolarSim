...
Utm32GridTile::Utm32GridTile(double originEastingM, double originNorthingM, double cellSizeM,
                             int columns, int rows, std::vector<double> heights,
                             double noDataValue)
...
bool Utm32GridTile::cellValue(int column, int row, double& value) const
{
...
bool Utm32GridTile::sampleUtm(double eastingM, double northingM, double& heightM) const
{
...
bool Utm32GridTile::sampleGeodetic(double latitudeDeg, double longitudeDeg, double& heightM) const
{
    double easting = 0.0;
    double northing = 0.0;
